...
*v5.3 · 2026-09-12 · 在 v5.2 基础上吸收 Material Design 3 机制层（on-* 前景色角色、状态层、emphasized 缓动），并给出 Ant Design 5 下游映射（附录 H）。设计语言底座维持自研，M3 仅吸收机制不引入风格。*
