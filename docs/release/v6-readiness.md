...
**发布序列(全部完成)**:冻结 SHA(349e02d 已签收)→ 三试点锁定(release-lock)→ 全量 CI 绿色(本批推送后验证)→ 线上冒烟(规范站+Kit 46 项对 218 已 PASS)→ 三方签字(rc 已签,正式版签收待此批绿后)→ **打 v6.0.0 tag(待负责人批准)** → Release Notes。
...
## 八、6.0.0 正式发布(2026-09-15,终态)

负责人批准发布基线 2af7196;版本真源/发布锁定/文档状态已统一切换 6.0.0(rc 仅存于历史记录);Release Notes 定稿;末批完整绿色 CI 后在该 SHA 上创建不可移动 annotated tag `v6.0.0`。锁定的发布组合:webui=v6.0.0 tag,TSSKB 5d92c8d / nvci-lite 9ff7d87 / ale-dan-cpl-system 0e288ec(v6-pilot)。后续工作按 §七(6.1 路线,98 分稳定目标)推进。
