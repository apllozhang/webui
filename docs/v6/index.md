...
id-prefix: GOV-CORE
---
# ALE WebUI 设计规范 v6.0（治理版骨架）
> 状态：**v6.0 v6.0.0-rc（治理版）**（版本真源自 2026-09-14 起为 6.0.0-rc，正式切换随 M6 发布流程）。内容迁移自 v5.4.1 只读基线（未新增规则）；规则 ID 体系与术语表自本版生效。
...
**桌面演练脚本（骨架选型培训用）**：给演练者本页 + 一个真实需求描述，10 分钟内说出：家族、模式、工程档、四链路取舍。有争议即术语表需修订。
